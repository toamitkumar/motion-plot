class VerticalBarChartViewController < UIViewController
  def init
    if super
      self.tabBarItem = UITabBarItem.alloc.initWithTitle('VerticalBar', image:UIImage.imageNamed('vertical_bar_chart.png'), tag:1)
    end
    self
  end
