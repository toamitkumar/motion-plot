class PercentStackedBarChartViewController < UIViewController
  def init
    if super
      self.tabBarItem = UITabBarItem.alloc.initWithTitle('PercentStacked', image:UIImage.imageNamed('percent_stacked_bar_chart.png'), tag:1)
    end
    self
  end
