class WaterfallChartViewController < UIViewController
  def init
    if super
      self.tabBarItem = UITabBarItem.alloc.initWithTitle('Waterfall', image:UIImage.imageNamed('waterfall_chart.png'), tag:1)
    end
    self
  end
